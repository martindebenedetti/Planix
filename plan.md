...
> Nota: Esta spec maestra orienta la primera entrega y sirve como referencia para construir las specs de cada rol y la implementación inicial de la página web.
